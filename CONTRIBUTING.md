...
6. A different member reviews the exact submission. The owner explicitly records acceptance from their harness. Acceptance does not merge the PR; repository review and merging are separate actions.
